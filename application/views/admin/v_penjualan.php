...
<head>
    ...
    <meta name="description" content="rahayu">
    <meta name="author" content="rahayu-web.my.id">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <table>
             ...
             <!-- TABLE INTI NYA DI MENU JUAL ACERAN -->
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">rahayu-web.my.id</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
